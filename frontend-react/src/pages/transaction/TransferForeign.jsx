...
const TransferForeign = () => {
    ...
    useEffect(() => {
        const fetchReceivers = async () => {
            try {
                const res = await axios.get("http://localhost:3001/bank_accounts/receiversforeign", { params: username });
    ...
    return (
        <>
            ...
            <Form>
            <h1 className="ml-auto">Transfer to Foreign Bank</h1>
            ...
            <Form.Group controlId="admin_fee">
                ...
                <Form.Control type="text" name="admin_fee" defaultValue="Rp. 10000" readOnly onChange={handleChange} />
            </Form.Group>
...
export default TransferForeign;
